...
class SoMedia_Settings {
	...
	function save() {
		...
		echo "<h2>VidWrx Account Settings</h2>";
		if (isset($_POST['submit'])) {
	
				if($_POST['method']=='save'){
					$authenticate = file_get_contents("http://partners.vidwrx.com/wordpress/wordpress-authorize?name=".$_POST['somedia_username']."&pass=".md5($_POST['somedia_password'])."&auth=b1477d3e885d44c03e164f26bf7b14ef");
					// var_dump($authenticate); die;
					...
					$create = json_decode(file_get_contents("http://partners.vidwrx.com/wordpress/embedded_create_user?auth=b1477d3e885d44c03e164f26bf7b14ef&email=".$_POST['somedia_username']."&pass=".$_POST['somedia_password']."&app=adv"),true);
	...
	function options_page() {
		...
		<h2>Your VidWrx Account Details:</h2>
		...
		<h2>Create a Free VidWrx Account:</h2>
